...
public class Evaluate {
    public static void main(String[] args) { 
        ...
        System.setIn(new ByteArrayInputStream(ap.nextString("Enter a fully parenthesized expression, separating each element by a space:").getBytes()));
        while (!StdIn.isEmpty()) {
