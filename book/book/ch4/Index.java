...
public class Index {
    public static void main(String[] args) {
        ...
        int minLength     = ap.nextInt("Enter the min length of the word");    // min length of word
        int minOccurrence = ap.nextInt("Enter the min number of occurences");    // min number of occurrences
